...
New-Item -Path "$PsScriptRoot/UnityProject/Assets/" -Name "Dependencies" -ItemType "directory" -Force
New-Item -Path "$PsScriptRoot/UnityProject/Assets/Dependencies/" -Name "GameLiftServerSDK" -ItemType "directory" -Force
Write-Host "Copying files.."
Copy-Item "Net45/bin/Release/*" -Destination "$PsScriptRoot/UnityProject/Assets/Dependencies/GameLiftServerSDK" -Force
cd ../../..
Remove-Item -Recurse -Force glsdk

# Fix the Newtonsoft JSON dll name because Unity 2020 has overlapping dll
Move-Item -Path "UnityProject/Assets/Dependencies/GameLiftServerSDK/Newtonsoft.Json.dll" -Destination "UnityProject/Assets/Dependencies/GameLiftServerSDK/Newtonsoft.Json.GameLift.dll" -Force 
...
New-Item -Path "UnityProject/Assets/Dependencies/" -Name "AWSSDK" -ItemType "directory" -Force
Copy-Item "aws-sdk-temp/AWSSDK.CognitoIdentity.dll" -Destination "UnityProject/Assets/Dependencies/AWSSDK/" -Force
Copy-Item "aws-sdk-temp/AWSSDK.CognitoIdentityProvider.dll*" -Destination "UnityProject/Assets/Dependencies/AWSSDK/" -Force
Copy-Item "aws-sdk-temp/AWSSDK.Core.dll" -Destination "UnityProject/Assets/Dependencies/AWSSDK/" -Force
Copy-Item "aws-sdk-temp/AWSSDK.DynamoDBv2.dll" -Destination "UnityProject/Assets/Dependencies/AWSSDK/" -Force
Copy-Item "aws-sdk-temp/AWSSDK.SecurityToken.dll" -Destination "UnityProject/Assets/Dependencies/AWSSDK/" -Force
Copy-Item "aws-sdk-temp/Microsoft.Bcl.AsyncInterfaces.dll" -Destination "UnityProject/Assets/Dependencies/AWSSDK/" -Force
Copy-Item "aws-sdk-temp/System.Threading.Tasks.Extensions.dll" -Destination "UnityProject/Assets/Dependencies/AWSSDK/" -Force
...
Write-Host "Copying files to the Unity project..."
New-Item -Path "UnityProject/Assets/Dependencies//" -Name "Signers" -ItemType "directory" -Force
New-Item -Path "UnityProject/Assets/Dependencies/" -Name "Util" -ItemType "directory" -Force
Copy-Item "signaturecalculation-temp/AWSSignatureV4-S3-Sample/Signers/*" -Destination "UnityProject/Assets/Dependencies/Signers/" -Force -Recurse
Copy-Item "signaturecalculation-temp/AWSSignatureV4-S3-Sample/Util/*" -Destination "UnityProject/Assets/Dependencies/Util/" -Force -Recurse
Write-Host "Removing the temporary files..."

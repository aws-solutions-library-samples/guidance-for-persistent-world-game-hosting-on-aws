...
mkdir ../../../UnityProject/Assets/Dependencies/GameLiftServerSDK
echo "Copying files.."
cp Net45/bin/Release/* ../../../UnityProject/Assets/Dependencies/GameLiftServerSDK/
cd ../../..
rm -rf aws-gamelift-sdk-temp

# Fix the Newtonsoft JSON dll name because Unity 2020 has overlapping dll
mv UnityProject/Assets/Dependencies/GameLiftServerSDK/Newtonsoft.Json.dll UnityProject/Assets/Dependencies/GameLiftServerSDK/Newtonsoft.Json.GameLift.dll 
...
mkdir UnityProject/Assets/Dependencies/AWSSDK
cp aws-sdk-temp/AWSSDK.CognitoIdentity.dll UnityProject/Assets/Dependencies/AWSSDK/
cp aws-sdk-temp/AWSSDK.CognitoIdentityProvider.dll UnityProject/Assets/Dependencies/AWSSDK/
cp aws-sdk-temp/AWSSDK.Core.dll UnityProject/Assets/Dependencies/AWSSDK/
cp aws-sdk-temp/AWSSDK.SecurityToken.dll UnityProject/Assets/Dependencies/AWSSDK/
cp aws-sdk-temp/AWSSDK.DynamoDBv2.dll UnityProject/Assets/Dependencies/AWSSDK/
cp aws-sdk-temp/Microsoft.Bcl.AsyncInterfaces.dll UnityProject/Assets/Dependencies/AWSSDK/
cp aws-sdk-temp/System.Threading.Tasks.Extensions.dll UnityProject/Assets/Dependencies/AWSSDK/
...
echo "Copying files to the Unity project..."
mkdir UnityProject/Assets/Dependencies/Signers/
mkdir UnityProject/Assets/Dependencies/Util/
cp -r signaturecalculation-temp/AWSSignatureV4-S3-Sample/Signers/ UnityProject/Assets/Dependencies/Signers/
cp -r signaturecalculation-temp/AWSSignatureV4-S3-Sample/Util/ UnityProject/Assets/Dependencies/Util/
echo "Removing the temporary files..."
